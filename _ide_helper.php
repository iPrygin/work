 ...
 * Generated for Laravel 5.2.45 on 2018-05-23 11:07:12.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Auth {
         ...
         *
         * @return \Chunker\Base\Models\User|null 
         * @static 
         */ 
         ...
         * @param mixed $id
         * @param bool $remember
         * @return \Chunker\Base\Models\User 
         * @static 
         */ 
    ...
    class Gate {
        ...
        public static function has($ability)
        {
            ...
            return \Chunker\Base\Gate::has($ability);
        }
        ...
        {
            //Method inherited from \Illuminate\Auth\Access\Gate            
            return \Chunker\Base\Gate::define($ability, $callback);
        }
        ...
        {
            //Method inherited from \Illuminate\Auth\Access\Gate            
            return \Chunker\Base\Gate::policy($class, $policy);
        }
        ...
        {
            //Method inherited from \Illuminate\Auth\Access\Gate            
            return \Chunker\Base\Gate::before($callback);
        }
        ...
        {
            //Method inherited from \Illuminate\Auth\Access\Gate            
            return \Chunker\Base\Gate::after($callback);
        }
        ...
        {
            //Method inherited from \Illuminate\Auth\Access\Gate            
            return \Chunker\Base\Gate::allows($ability, $arguments);
        }
        ...
        {
            //Method inherited from \Illuminate\Auth\Access\Gate            
            return \Chunker\Base\Gate::denies($ability, $arguments);
        }
        ...
        {
            //Method inherited from \Illuminate\Auth\Access\Gate            
            return \Chunker\Base\Gate::check($ability, $arguments);
        }
        ...
        {
            //Method inherited from \Illuminate\Auth\Access\Gate            
            return \Chunker\Base\Gate::authorize($ability, $arguments);
        }
        ...
        {
            //Method inherited from \Illuminate\Auth\Access\Gate            
            return \Chunker\Base\Gate::getPolicyFor($class);
        }
        ...
        {
            //Method inherited from \Illuminate\Auth\Access\Gate            
            return \Chunker\Base\Gate::resolvePolicy($class);
        }
        ...
        {
            //Method inherited from \Illuminate\Auth\Access\Gate            
            return \Chunker\Base\Gate::forUser($user);
        }
